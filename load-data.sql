...
-- [Problem 2]
LOAD DATA LOCAL INFILE 'contestants.csv' INTO TABLE contestants
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

-- -- [Problem 3]
LOAD DATA LOCAL INFILE 'positions.csv' INTO TABLE positions
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

-- -- [Problem 4]
LOAD DATA LOCAL INFILE 'responses.csv' INTO TABLE responses
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'questions.csv' INTO TABLE questions
